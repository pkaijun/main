...
[[editcase1]]
.Editing Case
image::userguide-images/ec-command1.png[width="400"]

[[editcase2]]
.Result
image::userguide-images/ec-command2.png[width="400"]
...
image::userguide-images/fc-command.png[width="350"]

[[findcases-calendar]]
.Finding cases by its name (Calendar View)
image::userguide-images/fc-command-calendar.png[width="350"]
...
[[deletecase-index]]
.Case Index
image::userguide-images/dc-index.png[width="280"]
...
image::userguide-images/sc-command.png[width="400"]
